...
public class CreateEnsiklopediaActivity extends AppCompatActivity {

    private String[] array_states = {"Kategori", "Ilmu Bedah", "Jantung", "Kulit","THT","Gigi","Anak"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_create_ensiklopedia);
